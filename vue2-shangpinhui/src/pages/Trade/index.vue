  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        ...
        deliveryAddress:this.userDefaultAddress.fullAddress,//住址
        paymentWay: "ONLINE",//支付方式
        orderComment: this.msg,//用户备注
        orderDetailList: this.orderInfo.detailArrayList//货物信息
      };
